...
- **Matériaux (*Soucca* 51b ; *Baba Batra* 4a)** : Hérode le construisit en pierres de marbre **blanc, bleu-vert et jaune** (shesh, marmara, kuchla) disposées en assises alternées ; il voulut le plaquer d'or, on lui conseilla de laisser la pierre visible car « cela ressemble aux vagues de la mer ».
- **Appareil (Melakhim I 7:9-12)** : le Temple est bâti d'**אַבְנֵי גָזִית**, et le Tanakh les mesure — « וּמְיֻסָּד אֲבָנִים יְקָרוֹת אֲבָנִים גְּדֹלוֹת **אַבְנֵי עֶשֶׂר אַמּוֹת וְאַבְנֵי שְׁמֹנֶה אַמּוֹת** » (7:10). Deux longueurs, pas une ; le verset les nomme toutes deux. Elles valent pour le bâtiment comme pour l'enceinte : « וְלַחֲצַר בֵּית ה' הַפְּנִימִית וּלְאֻלָם הַבָּיִת » (7:12). Les faces sont **sciées lisses** : « אֲבָנִים יְקָרֹת כְּמִדּוֹת גָּזִית **מְגֹרָרוֹת בַּמְּגֵרָה מִבַּיִת וּמִחוּץ** » (7:9) — donc pas de bossage rustique ; le relief tient au joint et au liseré ciselé qui le borde.
  → La **hauteur** d'assise n'est dans aucune source : **2,5 amot** pour l'enceinte, **2** pour le bâtiment (deux assises par rovad de 4, §8a) sont des CHOIX. Le blockout portait auparavant un module d'une ama, qui se lisait en brique — quarante rangs sur la façade au lieu de dix blocs.
...
- **Pas encore modélisé** : la **מְסִבָּה** qui monte du coin nord-est au nord-ouest, longe l'ouest puis le sud jusqu'à la porte de l'étage (*Middot* 4:5), et les **תָּאִים** qu'elle dessert. Le découpage nord-sud de *Middot* 4:7 — כותל המסיבה 5, המסיבה 3, כותל התא 5, התא 6, כותל ההיכל 6 — n'existe pas dans le blockout : le corps porte deux bandes pleines de 15 de chaque côté. La porte au sud de l'étage attend ce découpage.
