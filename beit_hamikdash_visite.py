...
VUES = [
    ...
    dict(id="vue_beit_hahalifot", position=(-84.0, 37.0, Z_BAT), cap=90, tangage=12),
    ...
    dict(id="vue_lishkat_haetzim", position=(120.0, 31.8, Z_EZN), cap=90, tangage=-6),
    dict(id="vue_lishkat_hanezirim", position=(120.0, -31.8, Z_EZN), cap=270, tangage=-6),
    dict(id="vue_lishkat_hametzoraim", position=(25.0, 31.8, Z_EZN), cap=90, tangage=-6),
    dict(id="vue_lishkat_beit_shemanya", position=(25.0, -31.8, Z_EZN), cap=270, tangage=-6),
    # Celles de sous l'Ezrat Israël sont couvertes : on les regarde depuis leur seuil, vers le fond.
    dict(id="vue_lishkot_haleviim", position=(-0.5, 16.5, Z_EZN), cap=180, tangage=-4),
    dict(id="vue_lishkat_chashaim", position=(-0.5, -23.0, Z_EZN), cap=215, tangage=-8),
    ...
    dict(id="vue_lishkat_hagola", position=(-172.0, 55.0, Z_AZ), cap=90, tangage=-5),
    dict(id="vue_lishkat_haetz", position=(-178.3, 78.5, Z_EZN), cap=0, tangage=3),
