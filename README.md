...
| `beit_hamikdash_figures.py` | Les figurants de la visite, chacun à un geste du tamid du matin que la Mishna lui donne — kiddoush yadayim au Kiyor, montée du kevesh, zerika, salage des membres, bois de la ma'arakha, hatavat hanerot dans le Heikhal, douze Léviim et deux enfants au Doukhan, un Lévi de garde à Nikanor, deux anshei ma'amad dans l'Ezrat Israël. Un rôle = un concept = une fiche. Corps MakeHuman (CC0), vêtus et animés ; écrit `visite/figures.glb` et `visite/figures.json`. Ni le .blend ni le film ne les voient. |
...
| `beit_hamikdash_parokhet.py` | Le motif tissé des deux Parokhot — keruvim, timorot et lions tissés par gpt-image-2 depuis des guides (`tissages/`, source versionnée), composés en registres autour de deux grands keruvim (Ye'hezkel 41:18-19) — en carte : R = hauteur du bombé, (G, B) = face du tissage qui affleure, alpha = figure ; écrit `visite/matieres/parokhet_2048.webp` et `parokhet.json` (laines, dosages, palette), que la matière du blockout et le nuanceur de la visite lisent tous deux en coordonnées de rideau. À relancer après toute modification, puis reconstruire. |
...
| `visite/parcours.js`, `visite/parcours.json` | Les parcours guidés, au choix dans le menu « Parcours… » : le tamid du matin (neuf stations, Tamid 1–7) et le seder ha'avoda de Yom Kippour (douze stations, de la Lishkat Parhedrin au Beit HaParva, Yoma 1–7). La visite marche seule d'une station à la suivante — au pas, ×2 ou ×4 — et ouvre la fiche de ce qu'on y voit. Les stations, en amot comme `cinema.json`, portent leurs points de passage et leur source. |
...
visite en `?vue=<degré>`. Avant la montée, une plongée sur les cours (caméra `ACC_09_Lishkot`)
porte un repère par lishka, posé là où Blender projette la chambre dans le cadre
(`CHAMBRES` dans `site/accueil.py`) : recadrer la caméra oblige à reprojeter les repères.
...
| `parokhet` | les deux rideaux : **les quatre laines dans chaque cordon** (*Shekalim* 8:5), et quatre **faces** du tissage qui les dosent autrement — fond de tekhelet assombri d'argaman (Menachot 43b), lions de lin à crinière cramoisie, keruvim cramoisis aux ailes de lin, timorot de lin à fût pourpre, lisière pourpre à rosaces et bandes de guilloché —, lues dans la carte de `beit_hamikdash_parokhet.py` : deux grands keruvim autour d'une timora au centre, lions en cortège vers un fleuron au-dessus, registres lion-timora-lion et keruv-timora-keruv (Ye'hezkel 41:18-19 ; I Rois 7:29, 36), figures tissées par gpt-image-2 dans la manière des tapisseries de l'Orient ancien ; aucun fil d'or (Ex. 26:31). Moyennées à parts égales, les quatre laines rendaient un mauve uni ; en grille d'aplats vectoriels, un papier peint |
...
- **Le marbre d'Hérode fait sa vague par la couleur.** La teinte est tirée par assise entre les trois marbres (*shesh*, *marmara*, *kuchla* — vert, blanc, bleu selon Rashi), et c'est leur écart qui fait « les vagues de la mer » : « שהאבנים משונים במראיהן זו מזו » (Rashi sur *Soucca* 51b). Le relief — « une assise en débord, une en retrait », « כי היכי דלקבל סידא », pour que l'enduit prenne — est le même que sur l'enceinte, et c'est lui qui entre dans la passe Normal. Sa face, elle, est celle d'un marbre et non d'un calcaire scié : polie, veinée, sans liseré, sans stries de scie, sans moucheture ni coulure.
- **La pierre fait huit ou dix amot, pas une.** « וּמְיֻסָּד אֲבָנִים יְקָרוֹת אֲבָנִים גְּדֹלוֹת אַבְנֵי עֶשֶׂר אַמּוֹת וְאַבְנֵי שְׁמֹנֶה אַמּוֹת » (*Melakhim I* 7:10), et ces pierres valent pour l'enceinte comme pour le bâtiment (7:12). Le module d'une ama qui les précédait donnait quarante rangs sur la façade au lieu de dix blocs, et se lisait en brique. Les faces sont **sciées lisses** (7:9, « מְגֹרָרוֹת בַּמְּגֵרָה מִבַּיִת וּמִחוּץ ») : tout le relief tient au joint et au liseré qui le borde, jamais à un bossage éclaté. La HAUTEUR d'assise n'est dans aucune source — **4 amot** pour l'enceinte, un CHOIX : une assise y vaut le pas d'un rovad de l'Oulam. Le bâtiment en prend **8** : à 4, ses vingt-cinq lits le lisaient en carrelage.
...
- **Le Sanhédrin a quitté la limite du sacré.** Le demi-cercle avait son diamètre sur l'axe du mur, et ses gradins se justifiaient par « 71 sièges ne tiennent pas sur un rang » — ce que les trois gradins ne tenaient pas non plus. Or *Sanhedrin* 4:4 met devant les juges « שָׁלֹשׁ שׁוּרוֹת שֶׁל תַּלְמִידֵי חֲכָמִים », assis eux aussi, donc dans le 'hol (« אֵין יְשִׁיבָה בָּעֲזָרָה », *Yoma* 25a) : il leur faut la place entre l'arc et la limite. L'arc recule au nord du פתח de 'hol, trois bancs droits le précèdent, deux pupitres pour les sofrim debout (*Sanhedrin* 4:3), le Nasi « בָּאֶמְצַע » (Tosefta *Sanhedrin* 8:1) et l'Av Beit Din à sa droite (Rambam *Sanhedrin* 1:3) sur deux sièges à dossier, et un filet de marbre marque la limite comme au Beit HaMoked. La salle montre la disposition, pas le nombre ; l'agrandir déplacerait tout le groupe du nord.
- **La Gazit prend son décor au Tanakh, pas à Rome.** Une première version l'avait faite majestueuse à la romaine — colonnes cannelées engagées, entablement, caissons à rosaces, édicule à fronton —, contre la consigne « rien de l'archéologie hérodienne » : la licence de Rambam *Beit HaBe'hira* 1:11 permet d'embellir, elle ne donne pas de forme. Refaite avec les versets : gazit coupée de « טוּר כְּרֻתֹת אֲרָזִים » au sud de la limite (*Melakhim I* 6:36 ; 7:12) ; au nord, la salle de jugement, sol de cèdre (7:7) et parois de cèdre sculptées de coloquintes et de fleurs (6:15, 6:18) ; plafond de poutres de cèdre (6:9) ; sièges sur le trône de Shlomo, dossier arrondi et accoudoirs (10:18-19), sans lions. Deux lectures corrigées en chemin : « סָפוּן בָּאֶרֶז מֵהַקַּרְקַע עַד הַקַּרְקָע » est un **sol** chez Rashi et Radak, pas un lambris — le lambris vient du Bayit ; et le « כֶּבֶשׁ בַּזָּהָב » du trône (*Divrei HaYamim II* 9:18) est une rampe (Metzudat Tzion), pas un marchepied, qui a donc disparu. Le revêtement de trois murs a été ramené au mur du fond, voir la puce suivante.
- **Le cèdre faisait chalet, et ce n'était pas le cèdre.** La nappe photographique du bois est un sapin à lames de 9 cm et à nœuds, réglée fort (couleur 0,70, relief 0,80) : sur 26 amot de paroi continue, un bardage. Trois corrections. Une famille `LAMBRIS` dans `visite/matieres.js`, pour la matière `Cedre_lambris` : même nappe, carreau de 3,6 m au lieu de 1,2, couleur 0,22, relief 0,30, fil procédural à moitié ; le bois des échelles, des bûches et des poutres ne change pas. Un revêtement en panneaux cadrés — fond, montants, traverses devant eux, un panneau par case — au lieu d'une surface nue, les fleurs et les coloquintes sur les traverses, les fleurs agrandies pour se lire de l'entrée. Et moins de bois : seul le mur du fond est revêtu, l'est et l'ouest reviennent à la gazit et à ses rangs de cèdre, ce qui borne aussi l'emprunt au Bayit.
...
- **Les six lishkot de *Middot* 5:3-4 sont bâties, et pas du même côté du mur.** « שֵׁשׁ לְשָׁכוֹת הָיוּ בָעֲזָרָה » : au nord HaGazit, HaGola et HaEtz, au sud HaMelah, HaParva et HaMedi'hin — girsa de *Yoma* 19a, du Rambam (*Beit HaBe'hira* 5:17) et de Tosfot Yom Tov sur *Middot* 5:3, contre le texte imprimé qui inverse les deux murs. **Les trois du sud et HaGola sont DANS l'Azara**, contre la face intérieure ; HaGazit est à cheval sur le mur, HaEtz seule sur la terrasse du 'Heil, comme les corps de porte. C'est le **Beit HaParva** qui impose le dedans : quatre des cinq immersions du Cohen Gadol se font sur son **toit**, et la Mishna dit ce toit dans le sacré — « וְכֻלָּן בַּקֹּדֶשׁ עַל בֵּית הַפַּרְוָה » (*Yoma* 3:3), « הֱבִיאוּהוּ לְבֵית הַפַּרְוָה, וּבַקֹּדֶשׁ הָיְתָה » (*Yoma* 3:6). Or un bâtiment élevé dans le 'hol et ouvert au קדש a son intérieur sanctifié et **pas son toit** (Tosfot Yom Tov *ad loc.*, d'après *Maasser Sheni* 3:8) : posée dehors, la Parva mettrait l'avoda dans le 'hol. Les deux autres du sud la suivent — HaMedi'hin par la מסיבה qui monte à son toit, HaMelah parce que *Middot* 5:3 les donne comme un groupe. Au nord, HaEtz est « אֲחוֹרֵי שְׁתֵּיהֶן », derrière HaGola : derrière, il n'y a que le mur, et la même règle **autorise** le dehors à une chambre sans usage connu. Ordre le long des murs : d'est en ouest, la formule « סמוכים למערב » manquant à la liste des lishkot (Tosfot Yom Tov, appuyé sur le schéma du commentaire du Rambam). Les x, eux, ne viennent d'aucune source.
- **HaGazit, HaGola, HaEtz : la disposition de Tosfot Yom Tov.** « וְהִיא הָיְתָה אֲחוֹרֵי שְׁתֵּיהֶן, וְגַג שְׁלָשְׁתָּן שָׁוֶה » (*Middot* 5:4) : Tosfot Yom Tov (*ad loc.*, d'après Shiltei HaGiborim) en tire HaGazit à l'est, devant ; HaGola derrière elle, côté cour ; HaEtz derrière HaGola, dos au nord — le mur passe entre les deux, comme il passe au milieu de HaGazit. Le groupe demande 44 amot de mur continu, que seule la portée à l'ouest de Sha'ar HaNitzotz offre — d'où le déplacement de HaGazit, de x −52..−32 à x −158..−138. Tous les corps du pourtour tiennent dans la même saillie de douze amot, et le soreg est à dix amot d'elle, au nord comme au sud. **Écart assumé** : HaEtz est entière dans le 'hol, alors que *Middot* 5:3 donne les six « בָּעֲזָרָה » — derrière HaGola, il n'y a que le mur.
...
- **La Menora se regarde de près.** Dans la visite on marche jusqu'à elle, et des cônes et des sphères à dix facettes n'y tenaient pas. Chaque ornement est maintenant tourné sur son profil, le long de sa tige ou de sa branche (`revolution_axe`) : la tige posée tefa'h par tefa'h comme dans *Mena'hot* 28b, une seule taille par sorte d'ornement (Rambam sur *Mena'hot* 3:7), coupes, boutons et fleurs aux formes de *Beit HaBe'hira* 3:9 et côtes d'amande, yerekh et trois pieds, lampes à bec tournées vers celle du milieu (3:8), et le kuz sur la deuxième marche (*Tamid* 3:9). Elle était aussi trop fine : creuse, ce que *Beit HaBe'hira* 3:4 permet, elle prend l'épaisseur d'un chandelier de temple sans dépasser son kikar d'or (Rashi sur *Shemot* 25:39). La visite y bat les cupules d'amande de l'or (`Or_mikshe`) et fait vaciller ses sept flammes. Tout est dans la fiche, avec ce qui reste CHOIX.
...
- **Les dix mekhonot** (*Melakhim I* 7:27-39) : socles 4 × 4 × 3 sur roues d'une ama et demie, cuve de quatre amot ; cinq par flanc, **sur l'épaule du bâtiment** — à côté du corps, sur le sol de l'Azara : l'otem de six amot ne déborde pas le corps (*Middot* 4:7). Les panneaux à lions, bœufs et keruvim ne sont que des cadres.
- **Keruvim, palmiers, fleurs épanouies, boutons et cordes** (*Melakhim I* 6:29 et 6:18 ; ordre de *Yé'hezkel* 41:18-19, keruv à deux visages) : en **relief** sur l'or de tous les murs du Heikhal et du Kodesh HaKodashim, « וּבוֹלֵט בִּמְקוֹם בְּלִיטָתוֹ » (Rashi 6:35) : deux registres jusqu'au-dessus de l'entrée (*Ye'hezkel* 41:20), keruv et **palmette de même hauteur, tangents** — sur les parois la תִּמֹרָה est « צוּרַת דִּקְלִין » (Targum Yonatan 6:29), rendue en grand éventail de palmes étagées plutôt qu'en arbre, et non le chapiteau que Rashi décrit sur *Ye'hezkel* 40:16, qui parle des jambages, **guirlandes** entre eux — un cordon torsadé, et boutons et corolles enfilés dessus, « אָטוּנִין שׁוֹשַׁנִין » (Targum Yonatan 6:29), « פְּטוּרֵי לְשׁוֹן חֲבָלִים » (Rashi 6:18) —, **montants tressés** aux deux angles (« מֵסַב קָלַע » = « מֻקֶּפֶת צִיּוּרִין », Rashi), et au-dessus de 22 amot le **panneautage** que *Ye'hezkel* 41:16-17 fait monter jusqu'au haut du mur — quatre rangs de panneaux carrés d'une même mesure (« מִדּוֹת »), chacun fermé par un cordon, sans aucune FIGURE (41:20), mais portant la brindille que *Melakhim I* 6:18 taille dans le lambris lui-même : « מִקְלַעַת פְּקָעִים וּפְטוּרֵי צִצִּים », le bouton et la fleur ouverte. 0,10 ama de saillie. Le keruv est la 'haya de la vision (*Ye'hezkel* 10:20) : deux ailes qui couvrent le corps, deux immenses ailes levées au-dessus de la tête à rangs de plumes étagés (1:11), les mains dessous, une jambe au sabot fendu (1:7), une petite tête à un seul crâne portant la face du lion et celle de l'homme, sans traits ; tendues à l'horizontale, les ailes se lisaient en aile d'Isis. Les vantaux portent les mêmes figures (41:25). Remplace le motif générique de rinceaux comme ornement du bâtiment (les maltera'ot gardent le leur).
