...
| `beit_hamikdash_gravures.py` | Les motifs gravés des parois du Bayit — keruv, keruv dressé, dattier, timora, fleuron, bouton, cordon, tresse, panneau. Le script dessine leurs guides (composition et iconographie, en dômes et sillons) ; les cinq **figures** sont ensuite taillées par gpt-image-2 (fal.ai) dans la manière de l'ornement judéen du Second Temple — ossuaires, portes de 'Houlda —, les tuiles taillées `gravures/*.png` étant la source versionnée. Le **cordon, la tresse et le panneau ne passent par aucun modèle** : une torsade est une figure géométrique qu'un compas dit exactement, et surtout une tuile qui se RÉPÈTE le long d'une paroi doit s'aboucher au pixel avec sa voisine, ce qu'aucun modèle ne garantit deux fois de suite. Le tout compose l'atlas `visite/matieres/gravures_3072.webp`, neuf tuiles de 1024, toutes prises (luminance = modelé, distance au bord = volume), plus `gravures.json` : la silhouette de chaque motif, tracée sur la carte même. Le blockout taille chaque figure à cette silhouette, 0,07 ama sous le nu : le fond de la taille a des UV qui visent la tuile, et le support perd le trou par un booléen ; la matière et le nuanceur lisent le modelé. Une bande qui répète une tuile (`_taille_repetee`) ne creuse qu'UNE taille et subdivise son fond, là où des centaines de tuiles isolées auraient rempli l'outil booléen de son support. À relancer après toute modification, puis reconstruire — et `TAILLE_TUILE` / `TEXEL_GRAVURE` (`visite/matieres.js`) et le nom de fichier (`visite/nappes.js`) suivent la grille. |
| `gravures/` | Les six tuiles taillées (`keruv.png`, `keruv_dresse.png`, `dekel.png`, `timora.png`, `fleuron.png`, `bouton.png`), sources de l'atlas, et les guides de tous les motifs dans `guides/`. |
...
- **La Lishkat HaEtz est en second rang, et c'est elle qui déplace le soreg.** « וְהִיא הָיְתָה אֲחוֹרֵי שְׁתֵּיהֶן, וְגַג שְׁלָשְׁתָּן שָׁוֶה » (*Middot* 5:4) : derrière HaGazit et HaGola, même niveau de toit pour les trois. Le groupe demande alors 44 amot de mur continu, que seule la portée à l'ouest de Sha'ar HaNitzotz offre — d'où le déplacement de HaGazit, de x −52..−32 à x −158..−138. **Écart assumé** : ce second rang met HaEtz entière dans le 'hol, alors que *Middot* 5:3 donne les six « בָּעֲזָרָה ». Dans la cour c'est impossible : à son droit, entre le mur nord et le Heikhal, il reste 32,5 amot (70 de corps, *Middot* 4:7), et cette bande est le « nord » de l'abattage, le Beit HaMitba'haïm à l'est. Le soreg se mesure désormais depuis sa face, la plus saillante du complexe.
...
- **Keruvim, palmiers, fleurs épanouies, boutons et cordes** (*Melakhim I* 6:29 et 6:18 ; ordre de *Yé'hezkel* 41:18-19, keruv à deux visages) : taillés dans l'or de tous les murs du Heikhal et du Kodesh HaKodashim, « לא שהיו בולטין » (Radak 6:29) : quatre registres jusqu'au-dessus de l'entrée (*Ye'hezkel* 41:20), keruv et **dattier de même hauteur, tangents** — sur les parois la תִּמֹרָה est « צוּרַת דִּקְלִין » (Targum Yonatan 6:29), un palmier entier et non le chapiteau que Rashi décrit sur *Ye'hezkel* 40:16, qui parle des jambages, **guirlandes** entre eux — un cordon torsadé, et boutons et corolles enfilés dessus, « אָטוּנִין שׁוֹשַׁנִין » (Targum Yonatan 6:29), « פְּטוּרֵי לְשׁוֹן חֲבָלִים » (Rashi 6:18) —, **montants tressés** aux deux angles (« מֵסַב קָלַע » = « מֻקֶּפֶת צִיּוּרִין », Rashi), et au-dessus de 22 amot le **panneautage** que *Ye'hezkel* 41:16-17 fait monter jusqu'au haut du mur — quatre rangs de panneaux carrés d'une même mesure (« מִדּוֹת »), chacun fermé par un cordon, sans aucune FIGURE (41:20), mais portant la brindille que *Melakhim I* 6:18 taille dans le lambris lui-même : « מִקְלַעַת פְּקָעִים וּפְטוּרֵי צִצִּים », le bouton et la fleur ouverte. 0,07 ama de taille. Le keruv est la 'haya de la vision (*Ye'hezkel* 10:20) : deux ailes qui couvrent le corps, deux qui se lèvent au-dessus de la tête (1:11), une jambe au pied rond (1:7), un seul crâne portant la face d'homme et celle du lion, sans traits. Ses ailes sont taillées penne par penne, dans la manière du keruv tissé de la parokhet ; tendues à l'horizontale, elles se lisaient en aile d'Isis. Remplace le motif générique de rinceaux comme ornement du bâtiment (les maltera'ot gardent le leur).
